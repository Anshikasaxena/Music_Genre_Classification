...
now = datetime.datetime.now()
    ...
    print("\nValidating ...")
    score, accuracy = model.evaluate(X_validation,
                                     y_validation,
                                     batch_size=batch_size,
                                     verbose=1)
...
load_data('../data_prep/43feature_proginprog/_validation.npy') 7
...
score, accuracy = model.evaluate(X_train,
                                 y_train,
                                 batch_size=batch_size,
                                 verbose=0)
...
labels, probs, names, y_true, im =
            predict('./saved_models/CNNW-20190501_16-50.h5',
            '../data_prep/43feature_proginprog/_validation.npy')
print_summary_statistics(probs, labels, y_true, names, im)
score, accuracy = model.evaluate(X_validation,
                                 y_validation,
                                 batch_size=batch_size,
...
labels, probs, names, y_true, im =
        predict('./saved_models/CNNW-20190501_16-50.h5',
                '../data_prep/43feature_proginprog/_test.npy',
                test=True)
print_summary_statistics(probs, labels, y_true, names, im)
score, accuracy = model.evaluate(X_validation,
                                 y_validation,
...
labels, probs, names, y_true, im =
            predict('./saved_models/CNNW-20190501_16-50.h5',
                    '../data_prep/43feature_proginprog/_djent.npy',
                    test=True)
print_summary_statistics(probs, labels, y_true, names, im)
